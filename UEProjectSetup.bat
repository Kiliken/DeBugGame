...
if exist "C:\Program Files\Epic Games\UE_5.6\Templates" set ueTempPath=C:\Program Files\Epic Games\UE_5.6\Templates
if exist "D:\Program Files\Epic Games\UE_5.6\Templates" set ueTempPath=D:\Program Files\Epic Games\UE_5.6\Templates
...
:: Inputs
if %true% robocopy "%ueTempPath%\TemplateResources\High\Input\Content" "%cd%\Content\Input" /E /NFL /NDL /NJH /NJS /NC /NS
